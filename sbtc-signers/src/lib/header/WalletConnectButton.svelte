...
<li class="nav-item dropdown">
	<span class="nav-link dropdown-toggle text-white" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
		User<!--<Person width={25} height={25}/>--> 
	</span>
	<ul class="dropdown-menu dropdown-menu-end border" aria-labelledby="navbarDropdown">
		...
		{:else}
			<span class="dropdown-item"><a href="/" class="pointer px-2" on:click|preventDefault={() => doLogin()} ><span  class="px-1">
				<!--<img src={stx_eco_wallet_off} alt="Connect Wallet / Login" width="40" height="auto"/> -->
			</span> connect</a></span>
		{/if}
		</li>
	</ul>
