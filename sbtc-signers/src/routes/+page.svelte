...
<div class="mx-auto flex flex-col justify-center px-6 lg:px-8 py-6">
  <div class="max-w-2xl">
    <div class="flex flex-col p-10 gap-6 items-start bg-gray-1000 border-[0.5px] border-gray-700 rounded-3xl">
      ...
      <div>
        <p class="mb-3 ">
            This is the public <strong>sBTC Signer Dashboard</strong> developed by the Stacks Community.
        </p>
        <p class="mb-3">
        ...
        <p class="mb-3">
            Signers can connect their real world identity via DNS and Social proofs to add 
            further credibility to the protocol. 
            This feature requires digital signatures and therefore connection to a Stacks Web Wallet. 
            <a class="text-hint-link" href="/wallet">Don’t have a wallet?</a>
        </p>
        <p class="mb-3">
