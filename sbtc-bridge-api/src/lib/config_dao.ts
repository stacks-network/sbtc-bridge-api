const DAO_CONFIG_DEVNET = {
    ...
    VITE_DOA_PROPOSAL: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bdp001-bootstrap',
    VITE_DOA_PROPOSALS: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bdp001-bootstrap',
