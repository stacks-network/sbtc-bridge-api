...
describe('bitcoin rpc suite - requires bitcoin core running on testnet', () => {
  ...
  */
  it.concurrent('Check parsing and building withdrawal payload 1', async () => {
    ...
    const amtScriptPubKey = '360000000000000320001409c7efcd51a08da9b4e38345645866c2a270eb39'
    let signature = "00b9710b4fda0bcf7a066d49f29ed76032c28862e5c496c5c9803501baa6130eb915e992eef765daaebf06acba5efa49ae8e0a438c5f22b03088c9d94dd061ca30"
